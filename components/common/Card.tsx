...
export default function Card({
  ...
  return (
    <Link href={`/properties/${id}`} className="block">
      <div className="w-[370px] bg-white rounded-lg shadow-md hover:shadow-lg transition cursor-pointer">
        <Image
          src={img}
          alt={title}
        ...
        <div className="p-4 flex flex-col gap-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              <div
                className="cursor-pointer bg-primary-extra-light text-primary-light p-1 rounded-sm"
